    ...
    <body>
        <div class="container">
            <nav class="navbar sticky-top navbar-expand-lg navbar-light bg-light custom-nav">
                <a class="navbar-brand" href="index.html">GLORIA STORE</a>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="about.html">READ</a>
                        <div class="dropdown">
            ...
            <section class="new-arrivals">
                ...
                <div id="carouselExampleControls" class="carousel slide carousel-custom" data-ride="carousel">
                    ...
                    <a class="carousel-control-prev col-sm-1" href="#carouselExampleControls" role="button" data-slide="prev">
                    ...
                    <a class="carousel-control-next col-sm-1" href="#carouselExampleControls" role="button" data-slide="next">
            ...
            <section class="collections">
                ...
                <div class="collections-products d-inline-flex flex-wrap justify-content-between align-items-center">
            ...
            <footer class="d-flex flex-row">
                <div class="col-sm-5 column d-flex flex-column p-0 wrapper">
